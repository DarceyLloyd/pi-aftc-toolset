---
name: plan-refactor
description: Create a detailed refactor plan via user interview, then save it as a refactor markdown doc. Use when the user wants to plan a refactor, create a refactoring RFC, or break a refactor into safe incremental steps.
---
...
Create a detailed refactor plan through a user interview. Save output to `REFACTOR_LATEST.md`.
...
After writing `REFACTOR_LATEST.md`, suggest running `kickoff-branch` next to create a refactor branch.
