---
name: define-success
description: Convert an imperative task statement into explicit 'step → verify: <cmd>' pairs before implementation begins. Forces concrete acceptance criteria. Use when the user gives a vague task and the verify steps aren't obvious, or before starting TDD.
---
