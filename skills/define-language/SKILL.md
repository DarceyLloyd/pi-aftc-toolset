...
description: Extract a DDD-style ubiquitous-language glossary from the current conversation or codebase, flagging ambiguities and proposing canonical terms. Use when starting a new domain, when terms are inconsistent across the codebase, or when the user asks for a domain model.
---
