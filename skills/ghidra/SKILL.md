---
name: ghidra
description: Reverse engineer binaries using Ghidra's headless analyzer. Decompile executables, extract functions, strings, symbols, and analyze control flow. Use when reverse engineering a binary, analyzing malware, or when the user asks to understand a closed-source executable.
---
