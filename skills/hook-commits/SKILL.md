---
name: hook-commits
description: Set up pre-commit hooks with a formatter, type checker, and tests in the current repo. Use when starting a new project, when the user asks to add git hooks, or to enforce commit-time checks.
---
