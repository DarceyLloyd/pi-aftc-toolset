...
description: Read this skill before updating changelogs. Enforces consistent changelog format, version grouping, and concise user-facing language. Use when committing changes that should be reflected in CHANGELOG, or when the user asks to update the changelog.
---
