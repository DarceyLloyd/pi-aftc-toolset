---
name: enforce-first
description: Apply the F.I.R.S.T test quality rubric (Fast, Independent, Repeatable, Self-Validating, Timely) to a test suite or individual test. Use when reviewing test quality, when tests are flaky or slow, or when the user asks for test quality improvements.
---
