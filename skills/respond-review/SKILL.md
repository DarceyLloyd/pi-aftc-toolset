---
name: respond-review
description: Act on a reviewer agent's feedback systematically - categorize findings, apply fixes, verify tests still pass. Use after running request-review and getting feedback, or when the user shares review comments to address.
---
