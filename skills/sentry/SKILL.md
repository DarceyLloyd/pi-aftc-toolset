---
name: sentry
description: Fetch and analyze Sentry issues, events, transactions, and logs to debug errors and find root causes. Use when investigating production errors reported by Sentry, when the user mentions a Sentry issue, or when correlating releases with new errors.
---
