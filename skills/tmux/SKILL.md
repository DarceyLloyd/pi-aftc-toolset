---
name: tmux
description: Remote control tmux sessions for interactive CLIs (python, gdb, node, etc.) by sending keystrokes and scraping pane output. Use when running an interactive command in a session, debugging a REPL, or scripting a long-running CLI workflow.
---
