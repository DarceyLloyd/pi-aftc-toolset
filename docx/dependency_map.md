...
<!-- last-verified: 2026-08-05 22:05 -->
...
| 1.8.1 /docx | 1.8.2 backup | backup errors abort BEFORE the model runs |
...
| zip-old.mjs | `docx/old_docs.zip` | the zip | deletes `old_docs/` only after the zip succeeds |
