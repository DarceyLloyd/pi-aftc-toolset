...
| 1.4.1 core (`tool_result`) | 1.4.4 recorder | `recordToolError` — a tool_result with `isError` → `classifyToolError` → `tool_errors` table |
...
| --- | --- |
| The AI model | 1.6.1 ssh_* tools · 1.7.4 codex_* tools · 1.5.12 run_script · 1.5.17 bg_* tools · 1.5.19 fd/rg · 1.9.6 subagent · prompt snippets/guidelines of all tools |
...
| OS file manager / clipboard / audio | 1.5.7 open · 1.5.1 clipboard · 1.5.18 copy-all clipboard · 1.5.4 player binary (2.1) |
