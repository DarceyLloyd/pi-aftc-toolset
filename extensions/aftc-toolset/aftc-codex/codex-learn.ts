...
export function createCodexLearn(ctx: CodexContext): CodexLearnApi {
    ...
    function buildLearnPrompt(): string {
        return [
            ...
            "   Routing: technology lessons -> resources/{languages|libraries|frameworks|engines|tools|runtimes|servers-and-containers|database|os|ui-ux}/<topic>.md (ui-ux nests by platform: ui-ux/web|desktop|mobile|plugin/<domain>.md); work-methodology lessons (planning, documentation) -> the root-level documentation-and-planning.md. The fixed top-level docs (codex-rules, guidance, markdown) are NEVER written by -learn.",
