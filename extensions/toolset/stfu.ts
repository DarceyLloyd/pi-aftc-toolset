 ...
 *     convention (rules.md §6.2). For when you want to be explicit.
...
async function handleStop(
    ...
    // running (extensions.md §"ctx.isIdle() / ctx.abort() / ..."). When
...
export function createStfu(pi: ExtensionAPI): void {
    ...
    // (rules.md §6.2). Use this when you want to be explicit.
